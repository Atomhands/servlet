...
public class WuXing {
    ...
    public WuXing(int year, int nMonth, int yMonth, int day, int time) {
        this.year = year;
        this.nMonth = nMonth;
        this.yMonth = yMonth;
        this.day = day;
    ...
    getMonth(String gzYear, int month) {
     ...
     * @return
     */
    public void wuxing(String gzYear, String gzMonth, String gzDay, String gzTime) {
        // 天干年
